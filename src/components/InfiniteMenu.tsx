...
class InfiniteGridMenu {
  ...
  constructor(canvas: HTMLCanvasElement, items: MenuItem[], onActiveItemChange: any, onMovementChange: any, onInit: any) {
    this.canvas = canvas;
    this.items = items || [];
  ...
  #updateCameraMatrix() {
    mat4.targetTo(this.camera.matrix, this.camera.position, [0.8, 0, 0], this.camera.up);
  ...
  #onControlUpdate(deltaTime: number) {
    ...
    if (!this.control!.isPointerDown) {
      ...
      if (nearestVertexIndex !== undefined && nearestVertexIndex !== null) {
