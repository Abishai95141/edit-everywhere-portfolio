...
export const BubbleMenu = ({
  ...
  return (
    <div
      ref={menuRef}
      className={`${useFixedPosition ? "fixed" : "absolute"} top-8 left-1/2 -translate-x-1/2 z-50`}
    >
      <motion.div
        className="flex items-center gap-6 px-6 py-4 rounded-full shadow-lg"
      ...
      >
        <div className="flex items-center gap-4">
          <div className="text-xl" style={{ color: menuContentColor }}>
            {logo}
          </div>
          ...
          >
            <div className="flex flex-col gap-1">
              <motion.span
                className="w-5 h-0.5"
                style={{ backgroundColor: menuContentColor }}
